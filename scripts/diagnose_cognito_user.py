...
def diagnose_user(email: str):
    ...
    print("="*80)
    print(f"🔍 DIAGNÓSTICO DE USUARIO EN COGNITO")
    print("="*80)
    print(f"Email: {email}")
    ...
    if status != "CONFIRMED":
        ...
        print(f"   aws cognito-idp admin-confirm-sign-up \\")
        print(f"       --user-pool-id {settings.COGNITO_USER_POOL_ID} \\")
    ...
    print(f"       --user-pool-id {settings.COGNITO_USER_POOL_ID} \\")
    print(f"       --username {email} \\")
    print(f"       --password 'TuNuevaContraseña' \\")
    print(f"       --permanent")
    ...
    if email_verified_attr and email_verified_attr['Value'] == 'false':
        ...
        print(f"       --user-pool-id {settings.COGNITO_USER_POOL_ID} \\")
        print(f"       --username {email} \\")
        print(f"       --user-attributes Name=email_verified,Value=true")
