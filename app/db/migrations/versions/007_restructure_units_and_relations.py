...
def upgrade() -> None:
    ...
    op.create_unique_constraint(
        "uq_unit_devices_unit_device", "unit_devices", ["unit_id", "device_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "granted_at", sa.TIMESTAMP(timezone=True), server_default=sa.text("now()")
        ),
    ...
    # Unique constraint
    op.create_unique_constraint(
        "uq_user_units_user_unit", "user_units", ["user_id", "unit_id"]
    )
